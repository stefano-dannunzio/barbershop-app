...
app.post('/api/bookings', async (req, res) => {
    const { serviceId, scheduledAt, customerName, customerPhone, barberId, barberName } = req.body;
...
app.get('/api/admin/summary', requireAdmin, async (_req, res) => {
    try {
        ...
        const upcomingBookings = bookings.filter((booking) => new Date(booking.scheduledAt) >= new Date() && booking.status !== 'cancelled').length;
        res.json({
            totalRevenue,
